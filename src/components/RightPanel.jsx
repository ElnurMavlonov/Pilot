...
export default function RightPanel() {
  return (
    ...
    >
      {/* ── Tab Navigation ── */}
      <div className="flex items-stretch border-b border-slate-100 shrink-0 bg-white min-w-0">
        <div className="right-panel-tabs flex items-center flex-1 min-w-0 overflow-x-auto px-2 pt-2 gap-0.5">
          <button
            id="tab-parts"
            onClick={() => switchTab('parts')}
            className="flex items-center gap-1.5 text-[11px] font-semibold px-3 py-2 rounded-t-lg border-b-2 border-blue-600 text-blue-700 bg-blue-50 transition-all cursor-pointer shrink-0 whitespace-nowrap"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-[11px] font-semibold px-3 py-2 rounded-t-lg border-b-2 border-transparent text-slate-500 hover:text-slate-700 transition-all cursor-pointer shrink-0 whitespace-nowrap"
          >
        ...
        <button
          className="p-1.5 m-1.5 text-slate-400 hover:text-slate-600 hover:bg-slate-100 rounded-lg transition-colors cursor-pointer shrink-0 self-center"
