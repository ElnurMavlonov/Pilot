...
export default function CommunityLibrary() {
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-100 bg-slate-900/75 backdrop-blur-sm opacity-0 pointer-events-none transition-opacity duration-300"
      onClick={handleBg}
    >
      <div className="flex items-center justify-center min-h-screen p-4">
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-5xl max-h-[90vh] overflow-hidden flex flex-col">
          ...
          <div className="flex items-center justify-between p-6 border-b border-slate-200">
            ...
            <button onClick={closeCommunityLibrary} className="p-2 hover:bg-slate-100 rounded-xl text-slate-400 hover:text-slate-700 transition cursor-pointer">
          ...
          <div className="flex border-b border-slate-200 px-6">
            <button onClick={() => switchCommunityTab('browse')} id="tab-browse" className="community-tab active px-4 py-3 text-sm font-semibold text-indigo-600 border-b-2 border-indigo-600 transition cursor-pointer">
              <i className="fa-solid fa-compass mr-2"></i>Browse
            </button>
            <button onClick={() => switchCommunityTab('publish')} id="tab-publish" className="community-tab px-4 py-3 text-sm font-semibold text-slate-500 hover:text-slate-700 border-b-2 border-transparent transition cursor-pointer">
              <i className="fa-solid fa-upload mr-2"></i>Publish
            </button>
            <button onClick={() => switchCommunityTab('my-circuits')} id="tab-my-circuits" className="community-tab px-4 py-3 text-sm font-semibold text-slate-500 hover:text-slate-700 border-b-2 border-transparent transition cursor-pointer">
          ...
          <div className="flex-1 overflow-y-auto p-6">
            ...
            <div id="browse-tab-content" className="community-tab-content">
              ...
              <div id="community-circuits-grid" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4"></div>
            </div>
            ...
            <div id="my-circuits-tab-content" className="community-tab-content hidden">
              <div id="my-circuits-grid" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4"></div>
